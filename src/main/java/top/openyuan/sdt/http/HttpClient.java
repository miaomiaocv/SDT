...
import top.openyuan.sdt.exception.ValidationException;
import top.openyuan.sdt.http.model.HttpHeaders;
...
public interface HttpClient {
   ...
   * @throws ValidationException 发送HTTP请求成功，验证合利宝支付返回签名失败。
