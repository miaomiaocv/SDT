package top.openyuan.sdt.http.model;

import com.alibaba.fastjson2.JSON;
import com.google.gson.JsonSyntaxException;
import top.openyuan.sdt.exception.MalformedMessageException;
import top.openyuan.sdt.http.model.data.JsonResponseBody;
import top.openyuan.sdt.http.model.data.ResponseBody;
...
public final class HttpResponse<T> {
  ...
  public static class Builder<T> {
    ...
    public HttpResponse<T> build() {
      ...
      T serviceResponse;
      try {
        serviceResponse = JSON.parseObject(originalResponse.getBody(), serviceResponseType);
