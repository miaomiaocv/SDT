package top.openyuan.sdt.http.constant;
...
public final class HttpConstant {
  ...
  public static final String USER_AGENT_FORMAT =
      "HeliPay-Java/%s (%s) Java/%s Credential/%s Validator/%s %s";
  ...
  public static final String HELI_PAY_SERIAL = "HeliPay-Serial";
  public static final String HELI_PAY_SIGNATURE = "HeliPay-Signature";
  public static final String HELI_PAY_TIMESTAMP = "HeliPay-Timestamp";
  public static final String HELI_PAY_NONCE = "HeliPay-Nonce";
