...
public class PemUtil {
   ...
   * @return 公钥
   */
  public static PublicKey loadPublicKeyFromPath(String keyPath, String algorithm, String provider) {
    return loadPublicKeyFromString(readKeyStringFromPath(keyPath), algorithm, provider);
  }
